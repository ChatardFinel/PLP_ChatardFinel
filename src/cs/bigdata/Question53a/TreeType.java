...
public class TreeType extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("TreeType");


        // On précise les classes MyProgram, Map et Reduce

        job.setJarByClass(TreeType.class);
        job.setMapperClass(TreeTypeMapper.class);
        job.setReducerClass(TreeTypeReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        TreeType exempleDriver = new TreeType();
