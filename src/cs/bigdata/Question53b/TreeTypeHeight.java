...
public class TreeTypeHeight extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("TreeTypeHeight");


        // On précise les classes MyProgram, Map et Reduce

        job.setJarByClass(TreeTypeHeight.class);
        job.setMapperClass(TreeTypeHeightMapper.class);
        job.setReducerClass(TreeTypeHeightReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        TreeTypeHeight exempleDriver = new TreeTypeHeight();
